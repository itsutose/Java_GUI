...
class DashCheckListener implements ItemListener {
	...
	if (state == ItemEvent.SELECTED)
	    JOptionPane.showMessageDialog(null, "dash line was checked!");
	else
	    JOptionPane.showMessageDialog(null, "dash line was unchecked!");
    }
}
...
class BoldCheckListener implements ItemListener {
	...
	int state = e.getStateChange();
	if (state == ItemEvent.SELECTED)
	    JOptionPane.showMessageDialog(null, "bold line was checked!");
	else
	    JOptionPane.showMessageDialog(null, "bold line was unchecked!");
    }
}