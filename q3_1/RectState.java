...
public class RectState extends State {
	...
	r.setSize(0, 0);
	r.setLineWidth(stateManager.getLineWidth());
	r.setLineNumber(stateManager.getLineNumber());
	r.setStrokeType(stateManager.getStrokeType());
	r.setHasShadow(stateManager.getHasShadow());
